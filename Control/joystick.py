...
class Joystick:
    def __init__(self,left_right_clip_val,forward_backwards_clip_val,rotate_clip_val,up_down_clip_val):
        ...
        self.joystick = pygame.joystick.Joystick(0) # Conectando com o joystick
        self.joystick.init()
        ...
        self.button_list=[ButtonIndex.EXIT,ButtonIndex.SIDE_BUTTON,ButtonIndex.TRIGGER] # Ler esses valores automaticamente
